...
STATIC_FOLDER = './static/comparison' # encoding save (graph)
...
@app.route('/generate_graphs_laptop', methods=['POST'])
def generate_graphs_laptop():
    data = request.json
...
@app.route('/generate_graphs_smart_watch', methods=['POST'])
def generate_graphs_smart_watch():
    data = request.json
    selected_products = data.get('products')
...
@app.route('/generate_graphs_headphone', methods=['POST'])
def generate_graphs_headphone():
    data = request.json
    selected_products = data.get('products')
...
@app.route('/generate_graphs_mobile', methods=['POST'])
def generate_graphs_mobile():
    data = request.json
    selected_products = data.get('products')
...
@app.route('/generate_graphs_tv', methods=['POST'])
def generate_graphs_tv():
    data = request.json
    selected_products = data.get('products')
